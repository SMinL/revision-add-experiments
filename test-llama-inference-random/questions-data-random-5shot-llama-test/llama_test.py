...
def test_examples_processing(path):
    ...
    model_name = "/home/wyd/model/Llama-2-7b-hf"  # 根据实际使用的模型调整名称
...
if __name__ == '__main__':
    ...
    llm = LLM(model="/home/wyd/model/Llama-2-7b-hf")
    ...
    paths = ['questions-v1.json','questions-v2.json','questions-v3.json','questions-v4.json']
    for path in paths:
        all_predictions = []
