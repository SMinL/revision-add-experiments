...
if __name__ == '__main__':
    #test
    # target_path = '/Users/smin/Desktop/polyu/project-cot-sql/sql-related/DAIL-SQL-VIS-SCHEMA-PROMPT-RANK/dataset/nvbench/test_gold_spider_style.sql'
    # target_path = '/Users/smin/Desktop/polyu/project-cot-sql/sql-related/DAIL-SQL-VIS-SCHEMA-PROMPT-RANK-Influence-cross-v1/dataset/nvbench/test_gold_spider_style.sql'
    # target_path = '/Users/smin/Desktop/polyu/project-cot-sql/sql-related/DAIL-SQL-VIS-SCHEMA-PROMPT-RANK-Influence-cross-v2/dataset/nvbench/test_gold_spider_style.sql'
    # target_path = '/Users/smin/Desktop/polyu/project-cot-sql/sql-related/DAIL-SQL-VIS-SCHEMA-PROMPT-RANK-Influence-cross-v3/dataset/nvbench/test_gold_spider_style.sql'
    # target_path = '/Users/smin/Desktop/polyu/project-cot-sql/sql-related/DAIL-SQL-VIS-SCHEMA-PROMPT-RANK-Influence-cross-v4/dataset/nvbench/test_gold_spider_style.sql'

    #dev
    # target_path  = '/Users/smin/Desktop/polyu/project-cot-sql/sql-related/DAIL-SQL-VIS-SCHEMA-PROMPT-RANK/dataset/nvbench/dev_gold_spider_style.sql'
    target_path = '/Users/smin/Desktop/polyu/project-cot-sql/sql-related/DAIL-SQL-VIS-SCHEMA-PROMPT-RANK-Influence-cross-v1/dataset/nvbench/dev_gold_spider_style.sql'
    # target_path = '/Users/smin/Desktop/polyu/project-cot-sql/sql-related/DAIL-SQL-VIS-SCHEMA-PROMPT-RANK-Influence-cross-v2/dataset/nvbench/dev_gold_spider_style.sql'
    # target_path = '/Users/smin/Desktop/polyu/project-cot-sql/sql-related/DAIL-SQL-VIS-SCHEMA-PROMPT-RANK-Influence-cross-v3/dataset/nvbench/dev_gold_spider_style.sql'
    # target_path = '/Users/smin/Desktop/polyu/project-cot-sql/sql-related/DAIL-SQL-VIS-SCHEMA-PROMPT-RANK-Influence-cross-v4/dataset/nvbench/dev_gold_spider_style.sql'
    pred_path = '/Users/smin/Desktop/VLDBJ-revise/added-experiments/test-llama-inference-random/questions-data-random-5shot-mistral-dev/questions-v1_prediction_new.txt'
    preds = []
    targets = []
    print(pred_path)
